...
import {
  ...
  Coffee, Leaf, Shield, Eye, Settings
} from "lucide-react";
...
const FontStyle = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .save-btn:hover { background: #0F1E38; box-shadow: 0 6px 28px rgba(27,42,74,0.35); transform: translateY(-1px); }
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        color: C.rose, textTransform: "uppercase",
      }}
    >
      <AlertCircle size={10} />
      {msg}
      ...
      <div style={{ position: "relative" }}>
        {icon && (
          <div style={{
            ...
            color: error ? C.rose : C.mist, pointerEvents: "none",
          }}>
            {icon}
          </div>
        )}
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: C.tealL, border: `1px solid ${C.tealM}`,
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 5 }}>
          ...
          />
          <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 8, color: C.teal, letterSpacing: "0.15em" }}>
            LIVE
          </span>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ padding: "26px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
            ...
            >
              {isTea
                ? <Leaf size={22} color={accent} />
                : <Coffee size={22} color={accent} />}
            </motion.div>
          ...
          <h3 style={{
            ...
            {form.factoryName || (
              <span style={{ color: C.mist, fontStyle: "italic", fontWeight: 400 }}>Unnamed Factory</span>
            )}
          </h3>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                ...
                <span style={{
                  ...
                  fontSize: 12.5, color: C.slate, lineHeight: 1.4,
                  overflow: row.truncate ? "hidden" : undefined,
      ...
      <div style={{
        ...
        <p style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 11.5, color: C.stone, lineHeight: 1.6 }}>
          This is how your factory appears to registered sellers in the public directory.
        </p>
      </div>
    </motion.div>
  );
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: C.paper, color: C.ink }}>
        ...
        <header style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: C.slate, letterSpacing: "0.14em" }}>
                FACTORY CONFIG
              </span>
            </div>
          </div>
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "56px 40px 80px" }}>
          ...
          >
            ...
            <h1 style={{
              ...
              Factory{" "}
              <span style={{ fontStyle: "italic", color: C.navy }}>Configuration</span>
            </h1>
            <p style={{
              fontFamily: "'IBM Plex Sans', sans-serif",
              fontSize: 13.5, color: C.stone, marginTop: 10, lineHeight: 1.7,
            }}>
              Configure your public procurement profile and pricing. Changes are reflected live in the directory.
            </p>
          </motion.div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 310px", gap: 28, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <Section
                ...
                icon={<Factory size={17} color={C.teal} />}
                delay={0.08}
              >
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
                  <InputGroup
                    ...
                    placeholder="e.g. Nilgiri Tea Estates"
                  />
                  <InputGroup
              ...
              {/* SECTION 2: Procurement & Pricing */}
              <Section
                title="Procurement & Pricing"
                icon={<IndianRupee size={17} color={C.teal} />}
                delay={0.14}
              >
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>

                  {/* Commodity type toggle */}
                  <div>
                    <FieldLabel>Commodity Type</FieldLabel>
                    <div style={{ display: "flex", gap: 8 }}>
                      {["Tea", "Coffee"].map(type => {
                        const active   = form.commodityType === type;
                        const isTypeTea= type === "Tea";
                        const bg       = active ? (isTypeTea ? C.teal : C.gold) : C.pearl;
                        const border   = active ? (isTypeTea ? C.teal : C.gold) : C.silk;
                        const color    = active ? "#fff" : C.slate;
                        return (
                          <motion.button
                            key={type}
                            whileTap={{ scale: 0.97 }}
                          ...
                          >
                            {isTypeTea
                              ? <Leaf size={14} color={active ? "#fff" : C.teal} />
                              : <Coffee size={14} color={active ? "#fff" : C.gold} />}
                            {type.toUpperCase()}
                          </motion.button>
                        );
                      })}
                  ...
                  <div style={{ gridColumn: "1 / -1" }}>
                    <FieldLabel>Factory Address</FieldLabel>
                    <div style={{ position: "relative" }}>
                      <MapPin
                        size={15}
                        style={{
                          position: "absolute", left: 14, top: 14,
                          color: errors.address ? C.rose : C.mist,
                          pointerEvents: "none",
                        }}
                      />
                      <textarea
                        ...
                        value={form.address}
                        onChange={handleChange}
                        placeholder="Full factory address including district and state"
                        className={`textarea-field ${errors.address ? "has-error" : ""}`}
                      />
                    </div>
        ...
        {/* ── FOOTER ─────────────────────────────────────── */}
        <footer style={{
          background: C.navy, padding: "24px 40px",
