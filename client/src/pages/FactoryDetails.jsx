...
import {
  ...
  Award, ShieldCheck, Activity, Leaf, Coffee, Zap, BarChart2
} from "lucide-react";
  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: 20, fontFamily: "'Playfair Display', serif", fontWeight: 700, color: C.navy }}>
        ₹{payload[0]?.value}
        <span style={{ fontSize: 12, color: C.stone, fontFamily: "'IBM Plex Mono', monospace", fontWeight: 400 }}>/kg</span>
      </p>
    </div>
  );
};
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: "0 1px 6px rgba(27,42,74,0.05)",
      }}
    >
      <div style={{
      ...
      <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: C.stone, letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 6 }}>
        {label}
      </p>
      <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: accentText || C.ink }}>
        {value}
      </p>
    </motion.div>
  );
...
function DetailRow({ icon, label, value }) {
  return (
    <div style={{
      ...
      <div>
        <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: C.stone, letterSpacing: "0.18em", marginBottom: 4 }}>
          {label}
        </p>
        <p style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 14, color: C.ink, fontWeight: 500, lineHeight: 1.4 }}>
          {value}
        </p>
      </div>
    </div>
      ...
      <div style={{ minHeight: "100vh", background: C.paper, color: C.ink }}>
          ...
          <div style={{
            ...
            >
              <div style={{
                ...
                background: C.pearl, border: `1px solid ${C.silk}`,
                display: "flex", alignItems: "center", justifyContent: "center",
              }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div style={{
                ...
                />
                <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: accent, letterSpacing: "0.15em" }}>
                  LIVE
                </span>
              </div>
            </div>
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "56px 40px 80px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 32, marginBottom: 48, alignItems: "start" }}>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
                ...
                <span style={{
                  ...
                  {factory.commodityType} Procurement Unit
                </span>
              </div>
              ...
              <div style={{ display: "flex", alignItems: "flex-end", gap: 20, flexWrap: "wrap" }}>
                <div>
                  <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: C.stone, letterSpacing: "0.22em", marginBottom: 8 }}>
                    CURRENT PRICE / KG
                  </p>
                  <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
                    ...
                    <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 13, color: C.stone, marginBottom: 8 }}>
                      /kg
                    </span>
                  </div>
                </div>
                ...
                {stats && (
                  <motion.div
                    ...
                    style={{
                      ...
                      background: isUp ? C.tealL : C.roseL,
                      border: `1px solid ${isUp ? C.tealM : C.roseM}`,
                      fontFamily: "'IBM Plex Mono', monospace",
                      fontSize: 13, fontWeight: 500,
                      color: isUp ? C.teal : C.rose,
                    }}
                  >
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: C.slate, letterSpacing: "0.18em" }}>
                    VERIFIED SOURCE
                  </span>
                </div>
              </div>
            ...
            >
              {isTea
                ? <Leaf size={44} color={accent} />
                : <Coffee size={44} color={accent} />}
            </motion.div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 28, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
              ...
              {stats && (
                <div style={{
                  ...
                  <StatCard
                    ...
                    icon={<Calendar size={17} color={C.blue} />}
                    accentBg={C.blueL} accentText={C.blue}
                    delay={0.20}
                  />
                </div>
              )}
              ...
              <motion.div
                ...
                style={{
                  ...
                  borderRadius: 18,
                  overflow: "hidden",
                  boxShadow: "0 2px 16px rgba(27,42,74,0.05)",
                }}
              >
                {/* Chart header */}
                <div style={{
                  ...
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                      ...
                      <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: accent, letterSpacing: "0.2em" }}>
                        PRICE PERFORMANCE
                      </span>
                    </div>
                    <h2 style={{
                      fontFamily: "'Playfair Display', serif",
                      fontSize: 20, fontWeight: 600, color: C.ink, letterSpacing: "-0.02em",
                    }}>
                  ...
                  <span style={{
                    fontFamily: "'IBM Plex Mono', monospace",
                    fontSize: 9, color: C.stone, letterSpacing: "0.1em",
                    padding: "6px 12px", background: C.pearl, borderRadius: 6,
                  }}>
                    AREA · ALL DATES
                  </span>
                </div>
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={history} margin={{ top: 8, right: 8, left: -12, bottom: 0 }}>
                      ...
                      <XAxis dataKey="date" axisLine={false} tickLine={false}
                        tick={{ fill: C.stone, fontSize: 10, fontFamily: "'IBM Plex Mono', monospace" }} dy={10} />
                      <YAxis axisLine={false} tickLine={false}
                        tick={{ fill: C.stone, fontSize: 10, fontFamily: "'IBM Plex Mono', monospace" }}
                        domain={["dataMin - 3", "dataMax + 3"]} />
                      <Tooltip content={<ChartTooltip />} cursor={{ stroke: accentM, strokeWidth: 1 }} />
                      {avgNum && (
                        <ReferenceLine y={avgNum} stroke={accentM} strokeDasharray="5 3"
                          label={{
                            value: `avg ₹${avgNum}`,
                            position: "insideTopRight",
                            fill: C.stone, fontSize: 10,
                            fontFamily: "'IBM Plex Mono', monospace",
                          }}
                        />
                      )}
            ...
            >
              ...
              <div style={{ padding: "26px 26px 30px" }}>
                <p style={{
                  fontFamily: "'IBM Plex Mono', monospace",
                  fontSize: 9, color: C.stone, letterSpacing: "0.25em", marginBottom: 22,
                }}>
                  FACTORY PROFILE
                </p>

                <DetailRow
                  icon={<User size={13} color={accent} />}
                  label="Manager / Owner"
                  value={factory.ownerName}
                />
                <DetailRow
                  icon={<Phone size={13} color={accent} />}
                  label="Direct Line"
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 18, fontWeight: 700, color: accent }}>
                      {factory.commodityType}
                    </p>
                  </div>
                  {isTea
                    ? <Leaf size={32} color={`${accent}80`} />
                    : <Coffee size={32} color={`${accent}80`} />}
                </div>

                {/* Price range */}
                {stats && (
                  <div style={{ marginTop: 22 }}>
                    <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: C.stone, letterSpacing: "0.15em", marginBottom: 10 }}>
                      PRICE IN RANGE
                    </p>
                    ...
                    {/* Track */}
                    <div style={{ height: 5, background: C.silk, borderRadius: 3, overflow: "hidden", position: "relative" }}>
                      {/* Avg marker */}
                      <div style={{
                        position: "absolute", top: 0, bottom: 0,
                        left: `${((parseFloat(stats.avg)-stats.lowest)/(stats.highest-stats.lowest))*100}%`,
                        width: 2, background: C.mist, transform: "translateX(-50%)",
                      }} />
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: `${((factory.pricePerKilo-stats.lowest)/(stats.highest-stats.lowest))*100}%` }}
                        transition={{ duration: 1, delay: 0.5, ease: [0.25, 1, 0.5, 1] }}
                        style={{
                          height: "100%", borderRadius: 3,
                          background: `linear-gradient(90deg, ${accentM}, ${accent})`,
                        }}
                      />
                    </div>
                    <p style={{
                      fontFamily: "'IBM Plex Mono', monospace", fontSize: 9,
                      color: C.stone, letterSpacing: "0.1em", marginTop: 7, textAlign: "center",
                    }}>
                      Current ₹{factory.pricePerKilo}
                    </p>
                  </div>
                )}
              </div>
